  ...
  return (
    <div className="flex items-center justify-center top-[calc(100vh_-_5vh)] ">
      ...
      <div className=" flex  flex-col md:flex-row w-full max-w-screen-xl md:p-4 md:px-8 xl:px-10 gap-x-6 gap-y-4 mb-[calc(100vh_-_85vh)]  lg:mb-0">
        ...
        {/* detail */}
        <div className="p-4 flex flex-col justify-between md:border-2 border-gray-200 md:rounded-lg md:w-1/4   ">
          <div className="flex flex-col gap-y-2 md:gap-y-4 md:mb-8 ">
            <div>
            ...
            <div className="flex items-center gap-x-1 text-sm">
              ...
              <span className="text-xs text-slate-600">گارانتی سلامت فیزیکی کالا</span>
            </div>
            ...
            <div className="flex items-center gap-x-1 text-sm">
              ...
              <span className="text-xs text-slate-600">موجود در انبار</span>
            </div>
            <div className="flex items-center gap-x-1 text-sm  ">
              <svg
                stroke="currentColor"
